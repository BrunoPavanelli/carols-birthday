...
const setPurple = () => { return purples[4] };
...
export const Message = styled.p`
  ...
  step === 4 &&
  css`
    background: linear-gradient(112deg,rgba(142, 68, 173, 1) 0%, rgba(173, 95, 173, 1) 18%, rgba(250, 232, 250, 1) 34%, rgba(247, 230, 247, 1) 50%, rgba(250, 232, 250, 1) 66%, rgba(173, 95, 173, 1) 83%, rgba(142, 68, 173, 1) 100%);
    ...
    animation: 
      ${popUp} 0.8s ease-out,
      ${animateGradient} 4s linear infinite;
  `}
  z-index: 999;
`;
